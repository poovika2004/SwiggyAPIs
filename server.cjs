...
async function connectToDb(){
    try{
        await mongoose.connect('mongodb+srv://poovi2004:Poovi60@cluster0.shz4szk.mongodb.net/swiggyDB?retryWrites=true&w=majority')
        ...
        console.log(error)
        console.log('Couldn\'t estalish connection :(')
}
}
connectToDb()
/**
...
app.get('/get-restaurant-details', async function(request,response){
    try{
        ...
        response.status(201).json(restaurantDetails)
